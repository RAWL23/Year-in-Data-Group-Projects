...
Global_sample <- na.pass(Global_sample$Country,Global_sample$ISO,Global_sample$Sex,Global_sample$Year,Global_sample$Region,Global_sample$Superregion) %<% Global_sample <- na.omit(Global_sample)
View(Global_sample)
